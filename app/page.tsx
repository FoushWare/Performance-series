...
const episodes: Episode[] = [
  ...
  { ep: 'E02', title: 'الضغط (Gzip/Brotli)', before: '/ep/02-compression/before', after: '/ep/02-compression/after', single: '/ep/02-compression' },
  ...
  { ep: 'E06', title: 'أنماط الرندر', before: '/ep/06-rendering/before', after: '/ep/06-rendering/after', single: '/ep/06-rendering' },
  ...
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '48px 24px' }}>
      ...
      <div style={{ display: 'grid', gap: 12, marginTop: 32 }}>
        {episodes.map((row) => (
          <Link key={row.ep} href={row.single} style={{ textDecoration: 'none' }}>
            <div style={{ 
              display: 'flex', 
              alignItems: 'center', 
              gap: 16, 
